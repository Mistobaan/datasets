...
_INFO_DIR = os.path.join(
    _TFDS_DIR, "testing", "test_data", "dataset_info", "mnist", "3.0.1"
)
_INFO_DIR_UNLABELED = os.path.join(
    _TFDS_DIR, "testing", "test_data", "dataset_info", "mnist_unlabeled", "3.0.1"
)
      ...
      feature {
        ...
        shape {
          dim {
            ...
            self.assertLen(
                train_split.statistics.features[
                    0
                ].num_stats.common_stats.num_values_histogram.buckets,
                10,
            )
            ...
            self.assertLen(
                test_split.statistics.features[
                    0
                ].num_stats.common_stats.num_values_histogram.buckets,
                10,
            )
