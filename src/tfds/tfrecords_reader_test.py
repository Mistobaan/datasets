...
class ReadInstructionTest(testing.TestCase):
    ...
    def test_invalid_spec(self):
        ...
        # Unexisting split:
        self.assertRaises("imaginary", 'Unknown split "imaginary"', exc_cls=ValueError)
...
class ReaderTest(testing.TestCase):
    ...
    def test_shuffle_files(self):
        train_info = self._write_tfrecord("train", 5, "abcdefghijkl")
        ds = self.reader.read("mnist", "train", [train_info], shuffle_files=True)
    ...
    def test_shuffle_deterministic(self):
        ...
        ds = self.reader.read(
            "mnist", "train", [split_info], read_config=read_config, shuffle_files=True
        )
