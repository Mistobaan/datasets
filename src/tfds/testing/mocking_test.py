...
# Lint as: python3
"""Tests for tfds.testing.mocking."""
...
from tfds.testing import mocking
from tfds.testing import test_case
...
class MockingTest(test_case.TestCase):
    ...
    def test_mocking_lm1b(self):
        with mocking.mock_data():
            ...
            self.assertEqual(
                ds.element_spec, {"text": tf.TensorSpec(shape=(None,), dtype=tf.int64),}
            )
            for ex in ds.take(10):
