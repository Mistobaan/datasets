...
from tfds.object_detection import voc
import tfds.public_api as tfds
from tfds.testing import fake_data_utils
...
def _generate_annotation(example_id, height, width):
    ...
    label_names = tfds.features.ClassLabel(
        names=voc._VOC2007_LABELS
    ).names  # pytype: disable=module-attr
    pose_names = tfds.features.ClassLabel(
        names=voc._VOC2007_POSES
    ).names  # pytype: disable=module-attr
