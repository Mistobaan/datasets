...
def mock_data(num_examples=1, as_dataset_fn=None, data_dir=None):
  ...
  """
    ...
    download_and_prepare_path = (
        "tfds.dataset_builder.DatasetBuilder.download_and_prepare"
    )
    as_dataset_path = "tfds.dataset_builder.FileAdapterBuilder._as_dataset"
    data_dir_path = "tfds.constants.DATA_DIR"
