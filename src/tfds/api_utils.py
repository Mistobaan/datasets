...
def disallow_positional_args(
    wrapped: None = ..., allowed: Optional[List[str]] = ...,
) -> Callable[[Fn], Fn]:
    ...
...
@typing.overload
def disallow_positional_args(
    wrapped: Fn, allowed: None = ...
) -> Fn:  # pylint: disable=g-wrong-blank-lines
    ...


def disallow_positional_args(
    wrapped=None, allowed=None
    ...
    if wrapped is None:
        return functools.partial(
            disallow_positional_args, allowed=allowed
